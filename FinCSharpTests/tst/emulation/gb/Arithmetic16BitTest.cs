...
namespace fin.emulation.gb {
  ...
  public class Arithmetic16BitTest : BOpcodesTestBase {
    ...
    private void TestAddHl_ToOther_Opcode_(
      ...
      Assert.AreEqual((addHlParams.Value + addHlParams.Delta) & 0xffff, lhs.Value);
    ...
    private void TestAddSp_Case_(AddSpParams addSpParams) {
      ...
      sbyte[] wrapper = {addSpParams.Delta};
      var converted = (byte[]) (Array) wrapper;
      var actualCycles =
          this.ExecuteInOrder(1, 0xe8, converted[0]);
