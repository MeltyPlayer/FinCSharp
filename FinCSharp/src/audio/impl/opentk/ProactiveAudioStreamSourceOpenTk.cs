  ...
  public partial class AudioOpenTk : IAudio {
    private partial class AudioFactoryOpenTk : IAudioFactory {
      ...
      public IAudioStreamSource NewAudioStreamSource(
          Action<byte[]> populateSubject,
          int channels,
          int bytesPerSample,
          int frequency,
          int numBuffers,
          int bufferSize) {
        var streamSource = new ProactiveAudioStreamSourceOpenTk(this.node_,
                                                       populateSubject,
                                                       channels,
                                                       bytesPerSample,
                                                       frequency,
      ...
      private class ProactiveAudioStreamSourceOpenTk : IAudioStreamSource {
