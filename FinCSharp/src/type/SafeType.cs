...
namespace fin.type {
  ...
  public sealed class SafeType<T> : Type, ISafeType {
    ...
    public override string? AssemblyQualifiedName =>
      this.Value.AssemblyQualifiedName;
    ...
    public override EventInfo?
      ...
      this.Value.GetEvent(name, bindingAttr);

    public override EventInfo[] GetEvents(BindingFlags bindingAttr) =>
      this.Value.GetEvents(bindingAttr);

    public override FieldInfo?
      GetField(string name, BindingFlags bindingAttr) =>
      this.Value.GetField(name, bindingAttr);

    public override FieldInfo[] GetFields(BindingFlags bindingAttr) =>
      this.Value.GetFields(bindingAttr);
    ...
    public override PropertyInfo[] GetProperties(BindingFlags bindingAttr) =>
      this.Value.GetProperties(bindingAttr);
    ...
    public override bool IsDefined(Type attributeType, bool inherit) =>
      this.Value.IsDefined(attributeType, inherit);
