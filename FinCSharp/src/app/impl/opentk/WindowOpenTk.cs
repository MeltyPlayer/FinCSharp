  ...
  public sealed partial class AppOpenTk : IApp {
    ...
    private sealed partial class WindowManagerOpenTk : IWindowManager {
      ...
      public IWindow NewWindow(IWindowArgs args)
        => this.parent_.instantiator_.Wrap(this.parent_.root_, new WindowOpenTk(args, this.parent_.ksd_, this.parent_.CloseApp_));
      ...
      private sealed partial class WindowOpenTk : BComponent, IWindow {
        ...
        private readonly INestedBoundingBoxes<int> viewport_ = new NestedBoundingBoxes<int>();
        private readonly IList<WindowOpenTkView> views_ = new List<WindowOpenTkView>();

        public WindowOpenTk(IWindowArgs args, IKeyStateDictionary ksd, Action onClose) {
          ...
          this.ksd_ = ksd;
          this.nativeWindow_.KeyDown += (sender, args) => ksd.OnKeyDown(OpenTkKeyToKeyIdConverter.Convert(args.Key));
          this.nativeWindow_.KeyUp += (sender, args) => ksd.OnKeyUp(OpenTkKeyToKeyIdConverter.Convert(args.Key));
          ...
          this.windowBoundingBox_ = new MutableBoundingBox<int>(0, 0, initialWidth, initialHeight);
          ...
          this.nativeWindow_.Resize += (_, _2) => {
            ...
            this.windowBoundingBox_.Dimensions.Height = this.nativeWindow_.Height;
          };

          this.viewport_.Push(this.windowBoundingBox_);
        }
        ...
        [OnTick]
        private void Render_(RenderTickEvent evt) {
        ...
        public int Width {
          ...
          set => this.windowBoundingBox_.Dimensions.Width = this.nativeWindow_.Width = value;
        }

        public int Height {
          get => (int)this.windowBoundingBox_.Dimensions.Height;
          set => this.windowBoundingBox_.Dimensions.Height = this.nativeWindow_.Height = value;
        }
