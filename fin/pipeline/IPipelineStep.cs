...
namespace fin.pipeline {
  ...
  public abstract class IPipelineStep<INPUT_TYPE, OUTPUT_TYPE> : IPipelineStep<INPUT_TYPE> {
    private readonly IList<IPipelineStep<OUTPUT_TYPE>> nextSteps_ = new List<IPipelineStep<OUTPUT_TYPE>>();
    ...
    public void Then<NEXT_OUTPUT_TYPE>(params IPipelineStep<OUTPUT_TYPE, NEXT_OUTPUT_TYPE>[] steps) {
    ...
    public IPipelineStep<OUTPUT_TYPE, NEXT_OUTPUT_TYPE> Then<NEXT_OUTPUT_TYPE>(IPipelineStep<OUTPUT_TYPE, NEXT_OUTPUT_TYPE> step) {
      // TODO: Detect cycles.
